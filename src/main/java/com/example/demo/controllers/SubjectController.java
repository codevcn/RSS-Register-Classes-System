...
//     @GetMapping("{input}")
//     public ResponseEntity<GetSubjectInfoResDTO> getSubjectInfo(@PathVariable String input)
...
//     public ResponseEntity<GetAllSubjectInfoResDTO> getSubject(@PathVariable("id") String id) {
...
//             new MajorOfSubjectResDTO(
//                 createsubject.getMajor().getId(),
//                 createsubject.getMajor().getName()
//             )
//         );
//         return ResponseEntity.ok(subjectInfoDTO);
//     }
...
//         List<GetAllSubjectInfoResDTO> subjectInfoList = subjects
//             .stream()
//             .map(
//                 subject ->
//                     new GetAllSubjectInfoResDTO(
//                         subject.getId(),
//                         subject.getName(),
//                         subject.getUpdatedAt(),
//                         subject.getCreditsCount(),
//                         new MajorOfSubjectResDTO(
//                             subject.getMajor().getId(),
...
//             new MajorOfSubjectResDTO(
//                 updatedSubject.getMajor().getId(),
//                 updatedSubject.getMajor().getName()
//             )
//         );
...
//         List<MajorOfSubjectResDTO> majorList = majors
//             .stream()
//             .map(major -> new MajorOfSubjectResDTO(major.getId(), major.getName()))
//             .collect(Collectors.toList());
