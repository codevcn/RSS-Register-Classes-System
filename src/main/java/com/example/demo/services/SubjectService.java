...
import com.example.demo.repositories.SubjectSlotRepository;
...
public class SubjectService {
    ...
    public Subject updateSubject(String id, SubjectResDTO.GetAllSubjectInfoResDTO updatedSubjectInfo) {
